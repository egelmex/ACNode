...
void EtherCard::browseUrl (const prog_char *urlbuf, const char *urlbuf_varpart, const prog_char *hoststr, void (*callback)(uint8_t,uint16_t,uint16_t)) {
    browseUrl(urlbuf, urlbuf_varpart, hoststr, PSTR("Accept: text/html"), callback);
}

void EtherCard::browseUrl (const prog_char *urlbuf, const char *urlbuf_varpart, const prog_char *hoststr, const prog_char *additionalheaderline, void (*callback)(uint8_t,uint16_t,uint16_t)) {
